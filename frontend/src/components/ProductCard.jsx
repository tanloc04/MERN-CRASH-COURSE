import { Box, Image, Heading, Text, HStack, IconButton, useColorModeValue, useToast, VStack, useDisclosure, Input, Button} from '@chakra-ui/react'
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <VStack spacing={4}>
                            ...
                            <Input placeholder ='URL Image' name ='image' value={updatedProduct.image} onChange={(e) => setUpdatedProduct({...updatedProduct, image: e.target.value})}/>
                        </VStack>
                    </ModalBody>
                    <ModalFooter>
